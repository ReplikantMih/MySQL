...
-- For `skills` table:
-- ALTER TABLE skills DROP FOREIGN KEY skills_profile_id_fk, DROP FOREIGN KEY skills_skill_type_id_fk;

ALTER TABLE `skills` 
ADD CONSTRAINT skills_profile_id_fk
...
ALTER TABLE `skills` 
ADD CONSTRAINT skills_skill_type_id_fk
...
-- ALTER TABLE invitations DROP FOREIGN KEY invitations_project_id_fk, DROP FOREIGN KEY invitations_freelancer_id_fk, DROP FOREIGN KEY invitations_invitation_status_id_fk;
...
ALTER TABLE `invitations` 
ADD CONSTRAINT invitations_freelancer_id_fk
	FOREIGN KEY (freelancer_id)
	REFERENCES freelancers(id)
		ON DELETE CASCADE
		ON UPDATE RESTRICT;
...
ALTER TABLE `invitations` 
ADD CONSTRAINT invitations_invitation_status_id_fk
	FOREIGN KEY (invitation_status_id)
	REFERENCES invitation_statuses(id)
		ON DELETE RESTRICT
		ON UPDATE RESTRICT;
